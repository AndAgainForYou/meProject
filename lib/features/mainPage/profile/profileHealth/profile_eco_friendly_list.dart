...
class ProfileEcoFriendlyListWidget extends StatefulWidget {
  const ProfileEcoFriendlyListWidget({super.key});

  @override
  State<ProfileEcoFriendlyListWidget> createState() =>
      _ProfileEcoFriendlyListWidgetState();
}

class _ProfileEcoFriendlyListWidgetState
    extends State<ProfileEcoFriendlyListWidget> {
  List<String> titles = [

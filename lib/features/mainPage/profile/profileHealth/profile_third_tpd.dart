...
class ProfileThirdTPDWidget extends StatefulWidget {
  const ProfileThirdTPDWidget({Key? key}) : super(key: key);

  @override
  _ProfileThirdTPDWidgetState createState() => _ProfileThirdTPDWidgetState();
}

class _ProfileThirdTPDWidgetState extends State<ProfileThirdTPDWidget> {
  List<String> titles = [

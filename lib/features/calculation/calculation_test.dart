...
class CalculateTestWidget extends StatefulWidget {
  const CalculateTestWidget({Key? key}) : super(key: key);

  @override
  _CalculateTestWidgetState createState() => _CalculateTestWidgetState();
}

class _CalculateTestWidgetState extends State<CalculateTestWidget> {
  List<String> titles = [
    "Adapt to Changes",
    "Weight Management",
    'Mood Stability',
